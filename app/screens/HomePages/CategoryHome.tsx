...
export const CategoryHome:FC<StackScreenProps<NavigatorParamList, "categoryHome">> = observer(
  ({ navigation }) => {
 ...
 <View style={styles.MainContainer}>
   ...
   <View style={{marginTop:'5%'}}>
    ...
    <TouchableOpacity style={{paddingLeft:15}} onPress={()=>(navigation.navigate('categoryHome'))}>
    ...
    <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:'3%'}}>
        ...
        <View style={{flex:1,marginTop:'3%'}}>      
          ...
          <TouchableOpacity  style={{marginLeft:10,borderColor:"#2A84F2",borderWidth:1,height:335,width:230,backgroundColor:'#FEFCFF',borderRadius:15}}  onPress={() => { navigation.navigate("buyAProduct")}}>
    ...
    <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:'3%'}}>
        <Text style={{paddingLeft:25,fontSize:20,fontWeight:'700'}}>Premuim Pluse Ads</Text>
        <TouchableOpacity onPress={()=>(navigation.navigate('homePremuim'))}>
        <Text style={{paddingRight:25,fontSize:20,fontWeight:'700'}}>See All</Text>
        </TouchableOpacity>
    </View>
 ...
 {/* =============Basic plus Ads */}
    <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:'3%'}}>
        ...
        <View style={{flex:1,marginTop:'3%'}}>      
          <ScrollView horizontal style={{height:'100%'}}>
          <TouchableOpacity style={{marginLeft:10,borderColor:"#F5F5F5",borderWidth:1,height:335,width:230,backgroundColor:'#FFFFF7',borderRadius:15}}  onPress={() => { navigation.navigate("buyAProduct")}}>
             <View style={{height:'60%',width:'90%',alignSelf:'center',backgroundColor:'red'}}>
              <Image source={require('../../../assets/images/RedHoddies.png')} style={{width:230,height:200,alignSelf:'center',borderTopLeftRadius:15,borderTopRightRadius:15}}/>
             </View>
             ...
             <View style={{flexDirection:'column',marginTop:5}}>
              <Text style={{  fontSize:18,textAlign:'center'}}>Red Hoodie in Good con..</Text>
              <View>
              <View style={{ flexDirection:'row',alignItems:'center',paddingLeft:10,marginTop:3}}>
              <Ionicons name="location-outline" size={15}/>
                 <Text>Washington,DC</Text>
                 </View>
                 <View style={{ flexDirection:'row',alignItems:'center',paddingLeft:10,marginTop:3}}>
                  ...
                  <View style={{paddingLeft:15,marginTop:'2%'}}>
                    <Text style={{fontSize:20,color:'#2A84F2',fontWeight:'600'}}>$1000</Text>
                  </View>
              </View>
             </View>
          ...
          <TouchableOpacity style={{marginLeft:10,borderColor:"#F5F5F5",borderWidth:1,height:335,width:230,backgroundColor:'#FFFFF7',borderRadius:15}}  onPress={() => { navigation.navigate("buyAProduct")}}>
             <View style={{height:'60%',width:'90%',alignSelf:'center'}}>
              <Image source={require('../../../assets/images/roadmasterBike.png')} style={{width:230,height:200,alignSelf:'center',borderTopLeftRadius:15,borderTopRightRadius:15}}/>
             </View>
             <View style={{flexDirection:'row',justifyContent:'space-around',marginTop:'3%'}}>
              <Text>Used</Text>
              <View style={{alignItems:'center',flexDirection:'row',justifyContent:'space-evenly'}}>
          ...
          <View style={{marginLeft:10,borderColor:"#F5F5F5",borderWidth:1,height:335,width:230,backgroundColor:'#FFFFF7',borderRadius:15}}>
             <View style={{height:'60%',width:'90%',alignSelf:'center'}}>
              <Image source={require('../../../assets/images/toyotaCar.png')} style={{width:230,height:200,alignSelf:'center',borderTopLeftRadius:15,borderTopRightRadius:15}}/>
             </View>
             <View style={{flexDirection:'row',justifyContent:'space-around',marginTop:'3%'}}>
              <Text>Used</Text>
              <View style={{alignItems:'center',flexDirection:'row',justifyContent:'space-evenly'}}>
