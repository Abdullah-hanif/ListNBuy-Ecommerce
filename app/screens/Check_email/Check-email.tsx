...
export const CheckEmail: FC<StackScreenProps<NavigatorParamList, "checkemail">> = observer(
  ({ navigation }) => {
    ...
    return (
      <View style={FULL}>
        ...
        <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
          ...
          <Icon icon="email" style={IGNITE} onPress={() => navigation.navigate("forgetpassword")} />
          <Text style={TITLE} preset="header" text="Check your email" />
          <Text style={TAGLINE} text="We have sent a password resent link to example@hmail.com" />
          ...
          <View>
            ...
            />
            <Text style={TAG} text="Don’t receive the email? Click to resend" />
