...
export const BuyAProductVideo: FC<StackScreenProps<NavigatorParamList, "buyAProductVideo">> = observer(
  ({ navigation }) => {
        ...
        <View style={{ flex: 1, marginTop: '3%' }}>
          ...
          <View style={{marginLeft:10}}>
            ...
            <View style={{marginTop:"3%"}}>
              <Image source={require('../../../assets/images/productVideo.png')} style={{width:"100%",height:290}} />
            </View>
            <View style={{
              width: '95%',
              alignSelf: "center",
